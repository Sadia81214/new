...
public class nidfront extends AppCompatActivity {
    Button imageChoose;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nidfront);
        getViews();
        role = getIntent().getStringExtra("role");

        // Set appropriate text based on role
        if (role.equals("Student")) {
            t.setText("Upload Guardian NID Front");
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                ImagesRef = storageRef.child("docs/NIDFront" + id + ".jpg");
    ...
    private void getViews() {
        imageChoose = findViewById(R.id.nfChoosebtn);
        picUpload = findViewById(R.id.nfup);
        imgurl = findViewById(R.id.nfimgurl);
        imgPreView = findViewById(R.id.nfimagePreview);
        t = findViewById(R.id.nft);
    }

    private void navigateToNextActivity() {
        Intent intent = new Intent(nidfront.this, nidback.class);
